...
public class CoderiveLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"SHIP", "LOCAL", "UNIT", "GET", "EXTEND", "THIS", "VAR", "OUTPUT", "INPUT", 
			"IF", "ELSE", "ELIF", "FOR", "BY", "IN", "TO", "INT", "STRING", "FLOAT", 
			"BOOL", "INT_LIT", "FLOAT_LIT", "STRING_LIT", "BOOL_LIT", "ID", "ASSIGN", 
			"PLUS", "MINUS", "MUL", "DIV", "MOD", "COLON", "GT", "LT", "GTE", "LTE", 
			"EQ", "NEQ", "DOT", "COMMA", "LPAREN", "RPAREN", "LBRACE", "RBRACE", 
			"LBRACKET", "RBRACKET", "LINE_COMMENT", "BLOCK_COMMENT", "WS"
		};
	}
	...
	public CoderiveLexer(CharStream input) {
		super(input);
		_interp = new LexerATNSimulator(this,_ATN,_decisionToDFA,_sharedContextCache);
	}

	@Override
	public String getGrammarFileName() { return "CoderiveLexer.g4"; }
