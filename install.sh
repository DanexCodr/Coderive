...
# ── Config ───────────────────────────────────────────────────────────────────
VERSION="$(cat "$(cd "$(dirname "${BASH_SOURCE[0]}")" 2>/dev/null && pwd || pwd)/VERSION" 2>/dev/null || echo "0.7.0")"
...
echo -e "  Try it now:"
echo ""
echo -e "    ${CYAN}coderive examples/hello.cod${RESET}          # hello world"
echo -e "    ${CYAN}coderive examples/fizzbuzz.cod${RESET}       # FizzBuzz with quantifiers"
echo -e "    ${CYAN}coderive examples/calculator.cod${RESET}     # interactive calculator"
echo -e "    ${CYAN}coderive examples/smart_loops.cod${RESET}    # loop patterns"
echo -e "    ${CYAN}coderive examples/lazy_arrays.cod${RESET}    # O(1) lazy arrays"
echo ""
echo -e "  Or try the web playground:"
echo -e "    ${CYAN}https://danexcodr.github.io/Coderive${RESET}"
echo ""
